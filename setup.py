...
VERSION = get_version('cohort_manager', '__init__.py')
...
setup(
    name='cohort_manager',
    version=VERSION,
    description="""Django plugin for copying cohorts between courses.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='OpenCraft',
    author_email='help@opencraft.com',
    url='https://github.com/open-craft/cohort-manager',
    packages=[
        'cohort_manager',
    ],
